...
public class WeatherClient {
    ...
    public void getAirport() {
        ...
        Response post = path.request().get();
    ...
    public void addAirport() {
        WebTarget path = collect.path("/airport/NSI/23/34");
        Response post = path.request().post(Entity.text(""));
        System.out.println("add airport : " + post);
    }
