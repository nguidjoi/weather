...
public interface WeatherQueryEndpoint {
     ...
     * <p>
     * Returns information about how the number of datapoint currently held in memory
     ...
     * @return an HTTP Response and a list of {@link AtmosphericItem} from the requested airport and
